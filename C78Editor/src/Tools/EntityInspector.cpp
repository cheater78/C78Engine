...
namespace C78Editor {
    ...
    //    if (scene->getAllEntitiesWith<C78E::TagComponent, C78E::TransformComponent>().size_hint()) {
    ...
    //
    //    static C78E::GUI::TextInput createEntityTI("New Entity:", "UnnamedEntity");
    //    static C78E::GUI::TextButton createEntityTB("Create Entity",
    //        [scene]() {
    //            std::string name = createEntityTI.getContent();
    //            if (name.empty()) name = "UnnamedEntity";
