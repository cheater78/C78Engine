		...
		public:
			static std::vector<Vertex> getVertexData(glm::vec3 pos1, glm::vec3 pos2, glm::vec4 color = glm::vec4(1.f, 1.f, 1.f, 1.f)) {
				return std::vector<Vertex>{
					Vertex(pos1, color, glm::vec3{ 0.f, 0.f, -1.f }, glm::vec2{ 0.0f, 0.f }, 0.f),
					Vertex(pos2, color, glm::vec3{ 0.f, 0.f, -1.f }, glm::vec2{ 0.0f, 0.f }, 0.f)
				};
			}
			static std::vector<uint32_t> getIndexData() { return std::vector<uint32_t>{ 0, 1 }; };
			static Mesh getMesh(glm::vec3 pos1, glm::vec3 pos2, glm::vec4 color) { return Mesh(getVertexData(pos1, pos2, color), getIndexData()); }
		private:
		};
