...
namespace C78E {
	...
	public:
		...
		Material(
			...
			MaterialPropertiesPBRext materialPropertiesPBRext = {0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f},
			MaterialTexturesPBRext materialTexturesPBRext = {AssetHandle::invalid(), AssetHandle::invalid(), AssetHandle::invalid(), AssetHandle::invalid(), AssetHandle::invalid()}
		)
			: m_Shader(shader),
