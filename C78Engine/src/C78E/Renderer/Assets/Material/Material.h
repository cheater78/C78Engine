...
namespace C78E {
	...
	public:
		...
		BasicMaterial(AssetHandle shader, IlluminationModel illuminationModel, MaterialProperties materialProperties, MaterialTextures materialTextures)
	...
	public:
		struct MaterialProperties {
			...
			float emissive = 0;											//Ke: emissive [0, 1] default 0
	...
	public:
		PBRMaterial() = default;
		PBRMaterial(AssetHandle shader, IlluminationModel illuminationModel, MaterialProperties materialProperties, MaterialTextures materialTextures)
			: Material(shader, illuminationModel), m_MaterialProperties(materialProperties), m_MaterialTextures(materialTextures) {
		}
		~PBRMaterial() = default;
	public:
