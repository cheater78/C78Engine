...
public:
    ...
    virtual ~VkUniformBufferTest() = default;
    ...
    void onAttach() override {
        ...
        C78E_INFO("VkUniformBufferTest attached!");
    }
    ...
    void onDetach() override {
        ...
        C78E_INFO("VkUniformBufferTest detached!");
    }
    ...
    void onEvent(C78E::Event& e) override {
        ...
        dispatcher.dispatch<C78E::KeyPressedEvent>(C78E_BIND_THIS_METHOD(VkUniformBufferTest::onKeyPressed));
        dispatcher.dispatch<C78E::MouseButtonPressedEvent>(C78E_BIND_THIS_METHOD(VkUniformBufferTest::onMouseButtonPressed));
        dispatcher.dispatch<C78E::WindowResizeEvent>(C78E_BIND_THIS_METHOD(VkUniformBufferTest::onWindowResize));
        dispatcher.dispatch<C78E::MouseMovedEvent>(C78E_BIND_THIS_METHOD(VkUniformBufferTest::onMouseMoved));
    }
